...
GAFE.Localization = {
  ...
  "Ajoute un peu de fonctionnalité et d'information a IU de Groupe et Recherche d'activités",
  ...
  Settings_LoopQueueCompletedNotification =
  "L'activité de la boucle a trouvé du son",
  ...
  Settings_AutoBind = "Lier automatiquement les objets non collectés",
  Settings_CompatibilityTitle = "Compatibility",
  Settings_PerfectPixelAddon = "PerfectPixel",
  Settings_ResetPremiumRewards =
  "Réinitialiser les minuteurs de récompense premium",
