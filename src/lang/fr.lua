...
GAFE.Localization = {
    ...
    Settings_LoopQueueCompletedNotification = "Répéter un son de l'activité trouvée",
    ...
    Settings_AutoInvite = "BETA Auto inviter",
    Settings_HandleQuest = "Accepter automatiquement la quête de serment",
    ...
    Settings_Difficulty = "Mode de difficulté",
    CheckActivePledges = "Serments",
    CheckMissingQuests = "Quêtes",
    CheckMissingSets = "Ensembles",
    ...
    TrialDreadsailReef = "Récif des Voiles funestes",
    LookForGroup = "LFG",
    LookForMore = "LFM",
