...
GAFE.Localization = {
  ...
  "Fügt der Benutzeroberfläche von Group & Activity Finder zusätzliche Funktionen und UI",
  ...
  Settings_ResetChestWarning =
  "Dadurch wird der Timer auf 1 Woche zurückgesetzt!",
  ...
  Settings_AutoBind = "Nicht gesammelte Gegenstände automatisch binden",
