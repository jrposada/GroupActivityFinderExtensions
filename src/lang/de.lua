...
GAFE.Localization = {
    Settings_Description = "Fügt der Benutzeroberfläche von Gruppe & Aktivitätensuche zusätzliche Funktionen und UI",
    Settings_AutoConfirm = "'Autom. bestätigen' Knopf",
    Settings_AutoConfirmDelay = "'Autom. bestätigen' verzögern",
    Settings_LoopQueueCompletedNotification = "Klang der gefundenen Aktivität endlos wiedergeben",
    Settings_TrialsChest = "Truhestimer zurücksetzen",
    ...
    Settings_AutoInvite = "BETA Auto einladen",
    ...
    Settings_Difficulty = "Schwierigkeitsmodus",
...
GAFE_DUNGEON_PLEDGE_QUEST_NAME = {
    ...
    [GAFE_PLEDGE_ID.CoralAerie] = "Der Korallenhorst",
