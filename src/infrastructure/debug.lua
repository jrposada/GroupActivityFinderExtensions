...
function GAFE.Debug.LogControlShown()
    ...
    for i = 1, num, 1 do
        ...
        if child then
            ...
            if control then
                ZO_PreHookHandler(_G[control:GetName()], 'OnEffectivelyShown',
                    function() GAFE.LogLater(GetTimeStamp() .. " " .. control:GetName() .. " shown") end)
            end
        end
    end
end
...
function GAFE.Debug.ExtractLocationsData()
    ...
    GAFE.SavedVars.LFG_ACTIVITY_BATTLE_GROUND_CHAMPION = ZO_ACTIVITY_FINDER_ROOT_MANAGER.sortedLocationsData
        [LFG_ACTIVITY_BATTLE_GROUND_CHAMPION]
    GAFE.SavedVars.LFG_ACTIVITY_BATTLE_GROUND_LOW_LEVEL = ZO_ACTIVITY_FINDER_ROOT_MANAGER.sortedLocationsData
        [LFG_ACTIVITY_BATTLE_GROUND_LOW_LEVEL]
    GAFE.SavedVars.LFG_ACTIVITY_BATTLE_GROUND_NON_CHAMPION = ZO_ACTIVITY_FINDER_ROOT_MANAGER.sortedLocationsData
    ...
    GAFE.SavedVars.LFG_ACTIVITY_MASTER_DUNGEON = ZO_ACTIVITY_FINDER_ROOT_MANAGER.sortedLocationsData
...
function GAFE.Debug.SetIds()
    ...
    ZO_PreHook("ZO_ItemSetsBook_Entry_Header_Keyboard_OnMouseUp",
        function(control, button, upInside) DebugLog(control) end)
end
