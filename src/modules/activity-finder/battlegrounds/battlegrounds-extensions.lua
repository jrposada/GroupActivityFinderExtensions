...
function GAFE_BATTLEGROUNDS_EXTENSIONS.Init()
    local function OnActivityFinderStatusUpdate(_, previousState, nextState)
        ...
        zo_callLater(function()
            local isRewardAvailableByTimer = extender.GetTimeUntilNextReward(extender.characterId, extender.rewardsVars) <=
                0
    ...
    EVENT_MANAGER:RegisterForEvent(extender.root .. "Activity_Update", EVENT_BATTLEGROUND_STATE_CHANGED,
