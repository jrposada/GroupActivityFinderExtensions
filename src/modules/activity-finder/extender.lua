...
function GAFE_ActivityFinderExtender:AddAchievement(_achivementId_, _controlName_,
                                                    _parent_, _texture_)
...
function GAFE_ActivityFinderExtender:AddQuest(_questId_, _controlName_, _parent_,
                                              _texture_)
...
function GAFE_ActivityFinderExtender:AddIcon(_controlName_, _parent_, _text_,
...
function GAFE_ActivityFinderExtender:Collapse()
  ...
  LibPanicida.Utils.CallLater(GAFE.name .. self.root .. "_Extensions", 200,
    collapse)
end
...
function GAFE_ActivityFinderExtender:QueueForMissingQuests()
  local function checkFunc(_obj_)
    ...
    return obj.gafeQuest and
        obj.node.data:GetActivityType() == self.dungeonDifficulty
  end
...
function GAFE_ActivityFinderExtender:RefreshDungeonDifficulty()
  ...
  self.dungeonDifficulty = savedVars.collapse == GAFE_COLLAPSE_MODE.Group and
      ...
      or
      (savedVars.collapse == GAFE_COLLAPSE_MODE.Normal and LFG_ACTIVITY_DUNGEON or LFG_ACTIVITY_MASTER_DUNGEON)
end

function GAFE_ActivityFinderExtender.GetTimeUntilNextReward(characterId,
                                                            rewardsVars)
  local result = 0
